...
The source code of the benchmark is distributed with Elektra, it is located at\\
...
\begin{lstlisting}[label=eval-1-code,language=C,caption={Excerpt of the first benchmark}]
