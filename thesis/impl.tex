...
\subsection{Why developing the plugin?}

In order to evaluate our performance related questions we need a reference application with a high degree of modularity.
The modularity is required to gain profound insight in the runtime behaviour of the reference application.
...
Elektra is a configuration database and as such it will also be used for storing sensitive configuration data (e.g. database passwords).
