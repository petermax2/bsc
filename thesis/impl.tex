...
The verification of the signature works like a regular decryption, which has already been shown in Listing \ref{list-fcrypt-dec} on page \pageref{list-fcrypt-dec}.
