...
\gcry ~provides the data structure \texttt{gcry\_cipher\_hd\_t} for communicating cryptographic keys to the API, thus it is used as \texttt{elektraCryptoHandle}.
