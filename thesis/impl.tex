...
\begin{enumerate}
\item the changes and enhancements that were made to Elektra in order to answer the research questions
\item the key concepts of Elektra (for example the plugin API)
\item the implementation details of the \crypto 
\item details about the deployed crypto libraries
\item the implementation details of the \fcrypt
\end{enumerate}
