...
Then we elaborate how Elektra's plugin system works.
...
The plugin checks the metakey and only encrypts values if the metakey is set accordingly.
...
Both features can be used separately or they can be combined together.
