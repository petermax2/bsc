...
\newcommand{\hypoTwo}[0]{{Introducing cryptography to an application significantly increases the memory consumption of the application.}}
...
\newcommand{\rqThree}[0]{{What runtime and memory overhead can be detected on average if OpenPGP encryption, decryption and signatures are applied to configuration files?}}
