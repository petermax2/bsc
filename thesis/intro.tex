...
Login credentials in this thesis refers to information that grants access to a system, for example:
...
Hibernate expects that its login credentials for the database server are provided in a XML configuration file as plain text.\cite{hibernate-doc}
...
Cryptography as security measure might also bring drawbacks in usability.
